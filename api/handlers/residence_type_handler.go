...
func (handler *ResidenceTypeHandler) Register(router *echo.Group, service *services.ResidenceTypeService, translator *translator.Translator, logger applogger.Logger) {
